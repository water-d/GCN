...
if __name__ == "__main__":
    ...
    parser.add_argument( '--n_clusters', type=int, default=20, help='number of clusters in Kmeans, when ground truth label is not avalible.') #5 on MERFISH, 20 on Breast
